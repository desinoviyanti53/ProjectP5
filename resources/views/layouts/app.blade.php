...
<head>
   ...
   box-shadow: 0 8px 15px rgba(26, 26, 26, 0.196); /* Efek bayangan */
 ...
 .card:hover {
   ...
   box-shadow: 0 12px 20px rgba(170, 182, 182, 0.925); /* Efek bayangan saat dihover */
 }
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        @else
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('destinasi.index') }}">Destinasi</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pengunjung.index') }}">Pengunjung</a>
                        </li>
                        <li class="nav-item">
